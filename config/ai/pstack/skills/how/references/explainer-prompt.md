...
or fill a gap. Use the current runtime's repository inspection operations as
needed. The explorers did the work, so you should not need to re-explore from
scratch.
